...
4. Preservation metrics: JSON parse rate, schema validity, code exact-match,
   placeholder leak rate (via tv.common.metrics.compute_preservation_metrics).
"""
...
from tv.common.io import read_jsonl, write_json
...
def main(config: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    from tv.common.io import setup_run_dir
